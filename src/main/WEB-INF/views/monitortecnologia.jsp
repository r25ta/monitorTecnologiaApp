...
<script
	src="<c:url value="/resources/jquery/jquery.quicksearch.min.js"/>"></script>
...
<body onload="doLoad(); atualizarIndicador(); alertaSonoro();">

	<!-- CARREGA ALERTA SONORO -->
	<audio id="alertaSonoro"
		src="<c:url value="/resources/media/alerta_sonoro.mp3"/>"></audio>

	<nav id="menu" class="navbar navbar-inverse" data-spy="affix"
		data-offset-top="0">
		<div class="container-fluid">
			<div class="navbar-header">
				<a href="#" class="navbar-brand">Monitor de Tecnologias
					Integradas</a>
			</div>
			<!-- 
			...
			<form class="navbar-form navbar-right">
				<div class="input-group">
					<input id="findTecnologia" type="text" class="form-control"
						placeholder="Pesquisar..." value="${tecnologia}">
	...
	<div class="container-fluid">
		<div class="row row-offcanvas row-offcanvas-left">
			<div class="col-sm-12 col-md-12 main">
				<div class="row placeholders" id="indicadores"
					style="display: none;">
				...
				<div class="row" style="font-size: 10px">
					<div class="col-sm-12" style="min-height: 25px;">
						...
						<label class="switch"> <input type="checkbox"
							id="chkDesativarAlertaSonoro"> <span class="slider round"></span>
							<span id="tituloAlertaSonoro"
							style="margin-left: 40px; width: 200px;">Desativar Alerta
								Sonoro</span>
				...
				<div class="row" style="font-size: 10px">
					<div class="col-sm-3">
						...
						<label class="switch"> <input type="checkbox"
							name="exibirIndicadores" id="chkExibirIndicadores" class="switch">
							<span class="slider round"></span> <span id="tituloIndicadores"
							style="margin-left: 40px; width: 200px;">Exibir
								Indicadores</span>
				...
				<div class="row" style="font-size:10px">
					<div class="col-sm-3">
						...
						<label class="switch">
  							...
  							<span id="tituloAtualizacaoAutomatica"
							style="margin-left: 40px; width: 200px;">Desativar Atualiza&ccedil;&atilde;o autom&atilde;tica</span>					
							...
							<thead>
								...
								<tbody id="tableBodyTecnologias">
									<c:forEach items="${monitor.tecnologias}" var="tecnologia">
										...
										<fmt:formatDate value="${tecnologia.dhrEvento}"
										pattern="dd/MM/yyyy HH:mm:ss" var="dhrEventoFormat" />													
										<fmt:formatDate value="${tecnologia.dhrProcForcedor}"
										pattern="dd/MM/yyyy HH:mm:ss" var="dhrProcForcedorFormat" />
										<fmt:formatDate value="${tecnologia.dhrProcPamcary}"
										pattern="dd/MM/yyyy HH:mm:ss" var="dhrProcPamcaryFormat" />

										<tr style="${colorLinha};font-size:11px">
											<td>
												<c:if test="${alerta}">
													<img
													src="<c:url value='/resources/images/sound-on-icon.png'/>"
													alt="Aviso Sonoro" style="width:20px;height:20px;" />
												</c:if>										
	...
	<footer style="font-size:10px">
		<p class="pull-right">GPS-Pamcary Logistica e Gerenciamento de Riscos</p>
	</footer>
